        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div className="space-y-6">
            ...
            <div className="flex space-x-4">
              <a href="#" className="text-cream/60 hover:text-[#E6C200] transition-colors" aria-label="Facebook">
                <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z" />
                </svg>
              </a>
              <a href="#" className="text-cream/60 hover:text-[#E6C200] transition-colors" aria-label="Instagram">
                <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a href="#" className="text-cream/60 hover:text-[#E6C200] transition-colors" aria-label="Twitter">
                <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li>
                <Link href="/collections" className="text-cream/70 hover:text-[#E6C200] transition-colors">
                  Collections
                </Link>
              </li>
              <li>
                <Link href="/about" className="text-cream/70 hover:text-[#E6C200] transition-colors">
                  About Us
                </Link>
              </li>
              <li>
                <Link href="/categories/caftans" className="text-cream/70 hover:text-[#E6C200] transition-colors">
                  Caftans
                </Link>
              </li>
              <li>
                <Link href="/categories/jellabas" className="text-cream/70 hover:text-[#E6C200] transition-colors">
                  Jellabas
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li>
                <Link href="/contact" className="text-cream/70 hover:text-[#E6C200] transition-colors">
                  Contact Us
                </Link>
              </li>
              <li>
                <Link href="/shipping" className="text-cream/70 hover:text-[#E6C200] transition-colors">
                  Shipping Info
                </Link>
              </li>
              <li>
                <Link href="/returns" className="text-cream/70 hover:text-[#E6C200] transition-colors">
                  Returns & Exchanges
                </Link>
              </li>
              <li>
                <Link href="/size-guide" className="text-cream/70 hover:text-[#E6C200] transition-colors">
                  Size Guide
                </Link>
              </li>
            </ul>
