        ...
        <div className="max-w-7xl w-full pl-4 md:pl-10 pr-4 md:pr-10">
          <div className="max-w-md mx-auto">
            <div className="bg-white rounded-lg shadow-sm p-8">
              <h1 className="text-3xl font-serif text-navy mb-6 text-center">Create an Account</h1>
              {error && (
                ...
                <div className="mb-6">
                  <label className="flex items-start">
                    <input
                      ...
                      className="h-4 w-4 mt-1 text-navy focus:ring-navy/30 border-gray-300 rounded"
                      required
                    />
                    <span className="ml-2 text-sm text-navy/70">
                      I agree to the{' '}
              ...
              <div className="mt-8 pt-6 border-t border-gray-200 text-center">
                <p className="text-sm text-navy/70">
                  ...
                  <Link href="/account/login" className="text-emerald font-medium hover:underline">
                    Sign in
                  </Link>
                </p>
              </div>
              ...
              <div className="mt-6">
                <div className="relative">
                  ...
                  <div className="relative flex justify-center text-sm">
                    <span className="px-2 bg-white text-navy/60">Or sign up with</span>
                  </div>
                </div>
