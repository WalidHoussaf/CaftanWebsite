  ...
  const tabContent = {
    Description: (
      <motion.div variants={tabContentVariants} className="space-y-8">
        <div className="relative overflow-hidden bg-[#F9F6F1] p-8 rounded-2xl border-2 border-[#E6C200]/20 shadow-md">
          <div className="absolute inset-0 bg-[radial-gradient(circle_at_top_right,rgba(251,191,36,0.04),transparent_60%)] pointer-events-none"></div>
          <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-[#E6C200] via-[#FFB823] to-[#FFF1CA]"></div>
          <div className="relative">
            <div className="flex items-center mb-4">
              <div className="w-10 h-10 bg-gradient-to-br from-[#E6C200] to-[#FFB823] rounded-xl flex items-center justify-center mr-4 shadow-lg">
              ...
              <h3 className="text-2xl font-serif text-navy font-semibold">Craftsmanship And Heritage</h3>
            </div>
            <p className="text-navy/80 leading-relaxed text-lg font-serif text-justify">{product.description}</p>
          </div>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-8">
          <motion.div 
            ...
            className="group relative overflow-hidden bg-cream p-8 rounded-2xl border-2 border-[#E6C200]/10 shadow-md"
          >
            ...
            <div className="relative">
              <div className="flex items-center mb-6">
                ...
                <h4 className="text-xl font-serif font-semibold text-navy">Artisan Tradition</h4>
              </div>
              <p className="text-navy/80 leading-relaxed text-justify font-serif">
          ...
          >
            ...
            <div className="relative">
              <div className="flex items-center mb-6">
                ...
                <h4 className="text-xl font-serif font-semibold text-navy">Design Excellence</h4>
              </div>
              <p className="text-navy/80 leading-relaxed text-justify font-serif">
    ...
    Details: (
      <motion.div variants={tabContentVariants} className="space-y-8">
        <div className="relative overflow-hidden bg-cream p-8 rounded-2xl border-2 border-[#E6C200]/20 shadow-md">
          <div className="absolute inset-0 bg-[radial-gradient(circle_at_bottom_left,rgba(79,70,229,0.04),transparent_60%)] pointer-events-none"></div>
          <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-[#E6C200] via-[#FFB823] to-[#FFF1CA]"></div>
          <div className="relative">
            <div className="flex items-center mb-6">
              <div className="w-10 h-10 bg-gradient-to-br from-[#E6C200] to-[#FFB823] rounded-xl flex items-center justify-center mr-4 shadow-lg">
              ...
              <h3 className="text-2xl font-serif text-navy font-semibold">Product Specifications</h3>
            </div>
              ...
              <div className="space-y-4">
                {[
                  ...
                  <motion.div
                    ...
                    className="flex items-center p-4 bg-cream rounded-xl border border-slate-200/50 hover:bg-cream/80 transition-colors duration-200"
                  >
    ...
    'Care Instructions': (
      <motion.div variants={tabContentVariants} className="space-y-8">
        <div className="relative overflow-hidden bg-cream p-8 rounded-2xl border-2 border-[#E6C200]/20 shadow-md">
          <div className="absolute inset-0 bg-[radial-gradient(circle_at_top_left,rgba(16,185,129,0.04),transparent_60%)] pointer-events-none"></div>
          <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-[#E6C200] via-[#FFB823] to-[#FFF1CA]"></div>
          <div className="relative">
            <div className="flex items-center mb-6">
              <div className="w-10 h-10 bg-gradient-to-br from-[#E6C200] to-[#FFB823] rounded-xl flex items-center justify-center mr-4 shadow-lg">
              ...
              <h3 className="text-2xl font-serif text-navy font-semibold">Care & Maintenance</h3>
            </div>
            ...
            <div className="grid lg:grid-cols-2 gap-8">
              <div className="space-y-6">
                <div className="flex items-center mb-4">
                  ...
                  <h4 className="text-lg font-semibold text-navy">Cleaning</h4>
                </div>
                <div className="space-y-4">
                  {[
                    ...
                    <motion.div
                      ...
                      transition={{ delay: index * 0.1 }}
                      className="flex items-start p-4 bg-cream rounded-xl border border-slate-200/50 hover:bg-cream/80 transition-colors duration-200"
                    >
                      <div className="w-3 h-3 bg-gradient-to-br from-emerald-400 to-green-500 rounded-full mr-4 mt-1 flex-shrink-0"></div>
                      <span className="text-navy leading-relaxed">{instruction}</span>
                    </motion.div>
                  ))}
                </div>
              </div>
              ...
              <div className="space-y-6">
                <div className="flex items-center mb-4">
                  ...
                  <h4 className="text-lg font-semibold text-navy">Handling</h4>
                </div>
                <div className="space-y-4">
                  {[
    ...
    Reviews: (
      <motion.div variants={tabContentVariants} className="text-center py-16">
        <div className="relative overflow-hidden bg-cream p-12 rounded-2xl border-2 border-[#E6C200]/20 shadow-md max-w-2xl mx-auto">
          <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,rgba(168,85,247,0.04),transparent_70%)] pointer-events-none"></div>
          <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-[#E6C200] via-[#FFB823] to-[#FFF1CA]"></div>
          <div className="relative">
            <motion.div
              animate={{ 
              ...
              className="w-20 h-20 bg-gradient-to-br from-[#E6C200] via-[#FFB823] to-[#FFF1CA] rounded-2xl flex items-center justify-center mx-auto mb-6 shadow-2xl"
            >
              <svg className="w-10 h-10 text-white" fill="currentColor" viewBox="0 0 20 20">
                <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
              </svg>
            </motion.div>
            <h3 className="text-2xl font-serif text-navy mb-4 font-semibold">Customer Reviews</h3>
            <p className="text-navy mb-8 text-lg leading-relaxed max-w-md mx-auto">
              Be the first to share your experience with this beautiful piece and help others discover its magic.
            </p>
            <motion.button
              whileHover={{ scale: 1.05, y: -2 }}
              whileTap={{ scale: 0.95 }}
              className="bg-gradient-to-r from-[#E6C200] to-[#FFB823] text-white px-8 py-4 rounded-full hover:from-[#E6C200] hover:to-[#FFB823] transition-all duration-300 shadow-lg hover:shadow-xl font-medium text-lg"
            >
              Write a Review
            </motion.button>
          </div>
      ...
      <div className="relative container mx-auto px-4 sm:px-6 lg:px-8 pt-32 pb-16">
        ...
        {relatedProducts.length > 0 && (
          <motion.div
            ...
            className="mt-20"
          >
            <div className="relative overflow-hidden bg-cream/60 backdrop-blur-xl rounded-3xl shadow-xl border border-cream/50 p-8 lg:p-12">
              ...
              <div className="relative">
                <div className="flex flex-col sm:flex-row items-center justify-between mb-12 gap-4">
                  <motion.h2 
                    initial={{ opacity: 0, x: -20 }}
                    animate={{ opacity: 1, x: 0 }}
                    className="text-3xl lg:text-4xl font-serif text-navy font-light"
                  >
                    You May Also Like
                  </motion.h2>
                  <motion.div 
